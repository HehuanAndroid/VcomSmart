        ...
        while (packetPosition < length) {
            ...
            if (type == 0x09) {
                ...
                if (rspData == 2) {
                    ...
                    //Log.e("curtain_test", meshUUID + "  productUUID:" + productUUID+"  productUUID TO INT: "+Integer.toHexString(productUUID) + "  " + status + "  " + meshAddress + "  " + Manufacture.getDefaultManufacture().getInfo());
